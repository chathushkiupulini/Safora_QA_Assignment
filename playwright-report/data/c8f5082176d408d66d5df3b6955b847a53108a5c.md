...
- Name: test\safora_contact_form.spec.js >> Safora – Contact Us Form >> TC-CON-04 | Invalid email format triggers validation error
- Location: test\safora_contact_form.spec.js:157:3
...
Locator: input[type="email"] + [class*="error"], [class*="error"]:near(input[type="email"]), text=/valid email|email address/i >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "input[type="email"] + [class*="error"], [class*="error"]:near(input[type="email"]), text=/valid email|email address/i". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 4000ms
  - waiting for input[type="email"] + [class*="error"], [class*="error"]:near(input[type="email"]), text=/valid email|email address/i >> nth=0
  ...
  - main [ref=e141]:
    ...
    - generic [ref=e213]:
      ...
      - generic [ref=e217]:
        ...
        - textbox "Email Address" [ref=e223]: not-a-valid-email

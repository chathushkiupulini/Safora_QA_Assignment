...
- Name: test\safora_contact_form.spec.js >> Safora – Contact Us Form >> TC-CON-05 | Validation error shown when Name field is blank
- Location: test\safora_contact_form.spec.js:175:3
...
Locator: [class*="error"], [aria-invalid="true"], text=/required|please enter|name/i >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "[class*="error"], [aria-invalid="true"], text=/required|please enter|name/i". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 4000ms
  - waiting for [class*="error"], [aria-invalid="true"], text=/required|please enter|name/i >> nth=0
...
- generic [ref=e1]:
  ...
  - main [ref=e141]:
    ...
    - generic [ref=e213]:
      ...
      - generic [ref=e217]:
        - textbox "Your Name" [ref=e220]
        - textbox "Email Address" [ref=e223]: jane.smith@example.com
        ...
        - button "Send Message" [ref=e239] [cursor=pointer]
